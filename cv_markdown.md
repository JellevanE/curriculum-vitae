...
<img src="images/profile_img.JPG" alt="Jelle van Elburg" />
...
- Designing and implementing LLM-based product recommendation pipelines, and integration with internal APIs
...
- Published and presented findings within academic and applied research settings  
...
- Developed technical prototypes and tools using Python to demonstrate LLM effectiveness across different tasks  
...
- Researched existing open-source models and hosting options  
- Developed a Retrieval-Augmented Generation (RAG) chatbot demo using Python libraries, including Langchain and Streamlit, to showcase practical applications to management  
...
- Assisted in developing policies for the technical aspects of archiving social media data  
...
- Authored detailed bug reports to ensure accurate and culturally appropriate localization  

## Education

### 2020 – 2021 · Universiteit van Amsterdam  
*Master Information Studies · Amsterdam*  

- Information Systems track, **8.0 GPA**  
- Thesis/Project: *Meaningful Annotation for Interactive Digital Narratives*  

### 2014 – 2020 · Universiteit van Amsterdam  
*Bachelor Bèta-Gamma · Amsterdam*  

- Major: Communication Science
- Minor: Theoretical Philosophy  
- Extracurricular courses on programming and AI  

## Skills

### Technical Expertise
 
- Building LLM-Powered Applications (Langchain/Langraph)
- Python 
- Context engineering 
- LLM evaluation and observation (Langsmith)
